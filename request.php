    ...
    <form method="POST" action="request_info.php" style="width:50%;border:1px solid gray;padding:10px">
        <label> Name</label> : <br>
    ...
    <form method="POST"  style="width:50%;border:1px solid gray;padding:10px">
        <label> Name</label> : <br>
        <input type="text" name="name"><br><br>
        <label>Age </label><br>
        <input type="text" name="age"></br><br>
